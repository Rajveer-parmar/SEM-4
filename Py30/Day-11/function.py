...
def is_var(a):
    if type(a) in [int, float, complex, str, chr]:
        return "yes"
    return "no"
...
def most_spoken_languages(n):
    ...
    n.sort(key=lambda x: x["population"], reverse=True)
    for i in range(11):
        print(n[i]['name'])
...
# print(add_all_num(10, 20, 30, 40))
# print(convert_celsius_to_fahrenheit(10))
# print(which_season('February'))
# print(slop())
# print(roots(5, 2, 7))
(print_list([1, 2, 3, 4]))
print(print_rev([1, 2, 3, 4, 5]))
print(capitalize_list_items(['rajveer', 'demo']))
print(add_item(['rajveer', 'demo'], "hello"))
print(sum_of_numbers(5))
print(sum_of_even(5))
print(sum_of_odd(5))
print(count_odd_even(100))
print(fact(3))
print(lalit_bhai([1, 2, 3, 4, 5, 6, 7, 8, 9]))
print(is_prime(4))
print(is_unique([1, 2]))
print(is_same_type([1, 2, 3, 4, 5.5]))
(most_spoken_languages(n))
